...
<div class="container mt-5">
	...
	{% include video_player.html title="From Memory" description="<p>An abstract piece I made for an art competition based on an image of hands playing with string. I finished it without leaving After Effects, mainly using Trapcode Tao. I also used my favourite discontinued plugin which I <a href=\"https://www.shadertoy.com/view/dsSGWm\" target=\"_blank\">recreated</a> on ShaderToy, Hall of Mirrors by Red Giant.</p><p>There isn't much story or purpose behind this, I just like how it looks and animates. I used CC Light Burst for the god rays, which adds visual interest and gives an ethereal feeling.</p>" video_id="302545077" color="#580D0F" %}
