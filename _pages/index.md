...
<main class="container mt-5">
	...
	<div style="padding: 56.25% 0 0 0;" class="position-relative mb-5">
		<iframe data-src="https://player.vimeo.com/video/1211133425?title=0&byline=0&portrait=0&quality=1080p" class="position-absolute top-0 left-0 w-100 h-100 lazy-iframe" allow="autoplay; fullscreen; picture-in-picture" title="Showreel"></iframe>
	</div>
	...
	{% include video_player.html title="VFX Showreel 2023" description="<p>This reel showcases all the projects I worked on during my time at <a href=\"https://ala-showcase.github.io\" target=\"_blank\">UTS Animal Logic Academy</a>.</p><p>It includes motion graphics, procedural modelling, shaders, scripting and simulations. I used a variety of software including Houdini, Blender, Nuke, After Effects and Unreal Engine.</p><p>More personal projects with similar style and content can be found on my <a href=\"https://github.com/MysteryPancake/Houdini-Fun\" target=\"_blank\">Houdini Fun</a> page.</p>" video_id="892894967" color="#492913" %}
	...
	{% include video_player.html title="Vertex Block Descent in Houdini" description="<p>I was very interested in the <a href=\"https://ankachan.github.io/Projects/VertexBlockDescent/index.html\" target=\"_blank\">Vertex Block Descent paper</a>, as it promised many improvements over Vellum (XPBD). I ported it to OpenCL to compare it.</p><p>Sadly VBD is not stable in general, but it taught me a lot about physics simulation and a lot about OpenCL, especially for managing workgroups.</p><p>I want to keep working on it to add support for rigid bodies and other features from the new <a href=\"https://graphics.cs.utah.edu/research/projects/avbd/\" target=\"_blank\">Augmented Vertex Block Descent paper</a>.</p>" video_id="1113876636" color="#001733" %}
	{% include video_player.html title="Fancy SDF Operations in Houdini" description="<p>This tutorial demonstrates many SDF operations in Houdini.</p><p>It includes the following topics:</p><ul><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#boolean-operations\" target=\"_blank\">Boolean operations</a> (union, subtraction, intersection, exclusive or)</li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#smooth-min\" target=\"_blank\">Smooth minimum</a></li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#domain-repetition\" target=\"_blank\">Domain repetition</a></li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#erodedilate\" target=\"_blank\">Erode/dilate</a></li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#3d-sdfs-formula-based\" target=\"_blank\">Coding SDFs</a></li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#4d-sdfs-formula-based\" target=\"_blank\">4D SDFs</a></li></ul>" video_id="xPrnFhfuuk4" color="#104870" youtube="true" %}
	{% include video_player.html title="Eikonal Contour Plotting in Copernicus" description="<p>The Eikonal node in Copernicus expands from darker areas into lighter areas, telling you how long it took.</p><p>It's great for generating SDFs, trippy effects and contour plotting!</p><p>It even runs in realtime on a webcam input. This lets you play around with lights and shadows to control the behaviour.</p>" video_id="s_av9vihvY0" color="#617010" youtube="true" %}
	{% include video_player.html title="No More Point Deform!" description="<p>People love using Point Deform for everything. There's much better ways to deform things depending what you're doing!</p><p>This video explains many alternative deformation methods, including the following:</p><ul><li>Primitive UVs</li><li>Surface Deform</li><li><a href=\"https://github.com/MysteryPancake/Houdini-Fun#hda-volumetric-deform\" target=\"_blank\">Positive Mean Value Coordinates / Volumetric Deform</a></li><li>Transform Pieces</li><li>Extract Transform</li><li>Volume Deform</li></ul>" video_id="FKUJcXB33oM" color="#701010" youtube="true" %}
	{% include video_player.html title="Relighting Gaussian Splats" description="<p>This tutorial shows how to <a href=\"https://github.com/MysteryPancake/Houdini-Fun#gaussian-splat-relighting\" target=\"_blank\">relight gaussian splats</a> using baked lighting from the Karma Texture Baker.</p><p>It supports animated lights, animated models and any lighting effect that can be baked to a texture.</p><p>This makes it much easier to integrate gaussian splats into an existing scene.</p><p>It also describes the diffuse-like and specular-like components of the spherical harmonic attributes, <a href=\"https://github.com/MysteryPancake/Houdini-Fun#gaussian-splat-components\" target=\"_blank\">including a visualizer</a> to view these components.</p>" video_id="BtbgwKK-WkY" color="#704b10" youtube="true" %}
