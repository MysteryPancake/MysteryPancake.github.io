...
<main class="container mt-5">
	...
	{% include video_player.html title="VFX Showreel 2023" description="<p>This reel showcases all the projects I worked on at <a href=\"https://ala-showcase.github.io\" target=\"_blank\">UTS Animal Logic Academy</a>.</p><p>I made motion graphics, procedural models, shaders, scripts and simulations. I used a variety of software including Houdini, Blender, Nuke, After Effects and Unreal Engine.</p><p>More projects with a similar style can be found on my <a href=\"https://github.com/MysteryPancake/Houdini-Fun\" target=\"_blank\">Houdini Fun</a> page.</p>" video_id="892894967" color="#492913" %}
